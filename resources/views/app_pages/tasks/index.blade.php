    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">List Tasks : <a class="float-end btn btn-info"
                                href="{{ route('task.create') }}">Create New <i class="fa-solid fa-circle-plus"></i> </a>
                        </h5>
                            ...
                            <tbody>
                                @forelse ($task as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td>
                                        <td>{{ $item->status }}</td>
                                        <td>{{ $item->create_by ?   $item->creator->email  : "Not"}}</td>

                                        <td>{{ $item->asign_to->name }}</td>
